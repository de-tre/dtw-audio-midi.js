...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/handles.js":[function(require,module,exports) {
...
window.onload = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
  var selector, features, dtwData, jsonPathData, inputFile, btn;
  return _regeneratorRuntime().wrap(function _callee3$(_context3) {
    while (1) switch (_context3.prev = _context3.next) {
      case 0:
        features = [0, 0];
        // Once a file button is pressed...
        inputFile = document.querySelectorAll('input[type=file]').forEach(function (e) {
          return e.addEventListener('click', function (event) {
            ...
            elem.onchange = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
              var url, fileObj, plotAudio, plotMIDI;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    url = null;
                    fileObj = document.querySelectorAll('input[type=file]')[selector].files[0];
                    ...
                    _context.next = 8;
                    return analyseAudio(url);
                  case 8:
                    features[0] = _context.sent;
                    _context.next = 28;
                    break;
                  case 11:
                    if (!(elem.id == "inputmidi")) {
                      _context.next = 28;
                      break;
                    }
                    ...
                    _context.next = 15;
                    return analyseMIDI(fileObj);
                  case 15:
                    features[1] = _context.sent;
                    _context.next = 28;
                    break;
                  case 18:
                    _context.prev = 18;
                  ...
                  case 28:
                    ...
                    if (!features[0].length < 1) {
                      plotAudio = chromaHeatMap(features[0], '$\\text{Audio STFT chroma } X_{n}$');
                      Plotly.newPlot('audiofeatures', plotAudio['plot'], plotAudio['layout'], {
                        scrollZoom: false
                      });
                    }
                    if (!features[1].length < 1) {
                      plotMIDI = chromaHeatMap(features[1], '$\\text{MIDI chroma } Y_{m}$');
                      Plotly.newPlot('midifeatures', plotMIDI['plot'], plotMIDI['layout'], {
                        scrollZoom: false
                      });
                    }
                  ...
                  case 36:
                    ...
                    _context.next = 42;
                    return dtw(features[0], features[1]);
                  case 42:
                    dtwData = _context.sent;
                    dtwData = {
                      path_P: dtwData[0],
                      costMatrix_D: dtwData[1]
                    };
        ...
        btn = Array.from(document.getElementsByClassName('btn')).forEach(function (e) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/handles.js"], null)
//# sourceMappingURL=/handles.3ffdf033.js.map